...
class TestCancelAchat(unittest.TestCase):
    def setUp(self):
    ...
    def test_cancel_achat(self):
        ...
        time.sleep(2)
        driver.find_element(By.XPATH, "//div[@id='Buy-1']/div/div/div[2]/div/button").click()
        time.sleep(2)
        driver.find_element(By.XPATH, "(.//*[normalize-space(text()) and normalize-space(.)='Info'])[1]/following::button[1]").click()
        time.sleep(2)
        driver.find_element(By.ID,"Buy-1").click()
        time.sleep(2)
        # SCREENSHOT 
        driver.save_screenshot('.\data\AnnulerAchat.png')
        driver.find_element(By.XPATH, "(.//*[normalize-space(text()) and normalize-space(.)='Info'])[1]/following::button[1]").click()
        time.sleep(2)
        driver.find_element(By.XPATH, "//div[@id='Buy-1']/div/div/div/button/span").click()
