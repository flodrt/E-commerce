...
class LoginLogoutAdminErrorPasswd(unittest.TestCase):
    def setUp(self):
    ...
    def test_login_logout_admin_error_passwd(self):
        driver = self.driver
        ...
        time.sleep(2)
        driver.save_screenshot("./data/login-admin-error-passwd-0.png")
        time.sleep(2)
        ...
        time.sleep(2)
        driver.save_screenshot("./data/login-admin-error-passwd-1.png")
        time.sleep(2)
