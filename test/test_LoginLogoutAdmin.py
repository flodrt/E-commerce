...
class LoginLogoutAdmin(unittest.TestCase):
    def setUp(self):
    ...
    def test_login_logout_admin(self):
        ...
        time.sleep(2)
        driver.save_screenshot("./data/login-admin-0.png")
        time.sleep(2)
        ...
        time.sleep(2)
        driver.save_screenshot("./data/login-admin-1.png")
        time.sleep(2)
        assert user == "Admin", "L'utilisateur loggé n'est pas Admin"

        driver.find_element(By.LINK_TEXT,"Logout").click()
        
        time.sleep(2)
        driver.save_screenshot("./data/login-admin-2.png")
        time.sleep(2)
