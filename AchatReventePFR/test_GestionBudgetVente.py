...
class AchatReventeTestConfirmationStockBudgetMessage(unittest.TestCase):
    ...
    def test_achat_revente_test_confirmation_stock_budget_message(self):
        ...
        #Recuperation et prix de l'article en text  +  conversion en float 
        ...
        driver.find_element(By.ID,"submit").click()  
        # SCREENSHOT 
        driver.save_screenshot('.\TEST_ProjetFilRouge\AchatReventePFR\Screenshots\BudgetAvVente.png')
        #recuperation prix Budget avant  vente
        ...
        # SCREENSHOT 
        driver.save_screenshot('.\TEST_ProjetFilRouge\AchatReventePFR\Screenshots\BudgetApVente.png')
        #Recuperation Budget avant en text  +  conversion en float 
