...
class AchatReventeTestConfirmationStockBudgetMessage(unittest.TestCase):
    ...
    def test_achat_revente_test_confirmation_stock_budget_message(self):
        ...
        #Recuperation du nombre d'article dans le stock avant le retour de l'article
        ...
        #Recuperation du nombre d'article dans le stock, apres le retpur
        ...
        ValeurAttendue=NbArticleAchete+NbArticleStockAv
        print (ValeurAttendue)
        print ("------------------------------------------------")
        # # ASSERT
        self.assertEqual (NbArticleStockAp, ValeurAttendue  )
