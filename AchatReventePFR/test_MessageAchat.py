...
class AchatReventeTestConfirmationStockBudgetMessage(unittest.TestCase):
    ...
    def test_achat_revente_test_confirmation_stock_budget_message(self):
        ...
        msgConfirmationA = driver.find_element(By.XPATH, "//body/div[1]").text
        msgConfirmationA = msgConfirmationA [2:]
        ...
        # SCREENSHOT 
        driver.save_screenshot('.\TEST_ProjetFilRouge\AchatReventePFR\Screenshots\MessageConfAchat.png')
        #Recuperation message confirmation d'achat
        ...
        #TEST MESSAGE CONFIRMATION ACHAT 
        print("----------------------------------------------------------------")
        print (msgConfirmationA)
        ValeurAttendue="Congratulations! You purchased IPhone 15 for 3000$"
        print (ValeurAttendue)
        print ("------------------------------------------------")
        # ASSERT
        self.assertEqual (msgConfirmationA, ValeurAttendue  )
