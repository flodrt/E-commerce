...
class CreateAccountWithMailAlreadyUsed(unittest.TestCase):
    def setUp(self):
    ...
    def test_create_account_with_mail_already_used(self):
        driver = self.driver
        ...
        driver.find_element(By.ID,"username").send_keys("dhdth")
        driver.find_element(By.ID,"email_address").click()
        driver.find_element(By.ID,"email_address").clear()
        driver.find_element(By.ID,"email_address").send_keys("flodrt@hotmail.fr")
        ...
        # SCREENSHOT 
        driver.save_screenshot('.\TEST_ProjetFilRouge\CreateAccountPFR\Screenshots\ErrorMailUsed.png')
        #TEST 
        ...
        print (msgErreur)
        ValeurAttendue="There was an error with creating a user: ['Email Address already exists! Please try a different email address.']"
