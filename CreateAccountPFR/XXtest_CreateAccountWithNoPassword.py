...
class CreateAccountWithNoPassword(unittest.TestCase):
    def setUp(self):
    ...
    def test_create_account_with_no_password(self):
        ...
        driver.find_element(By.ID,"username").send_keys("afaf")
        driver.find_element(By.ID,"email_address").click()
        driver.find_element(By.ID,"email_address").clear()
        driver.find_element(By.ID,"email_address").send_keys("afaezg@afeaef.com")
