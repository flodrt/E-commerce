...
class CreateAccountWithInvalidMail(unittest.TestCase):
    def setUp(self):
    ...
    def test_create_account_with_invalid_mail(self):
        driver = self.driver
        ...
        driver.find_element(By.ID,"username").send_keys("flo")
        driver.find_element(By.ID,"email_address").click()
        driver.find_element(By.ID,"email_address").clear()
        driver.find_element(By.ID,"email_address").send_keys("flo")
        ...
        # SCREENSHOT 
        driver.save_screenshot('.\TEST_ProjetFilRouge\CreateAccountPFR\Screenshots\ErrorMailInvalid.png')
         #TEST
        ...
        print (msgErreur)
        ValeurAttendue="There was an error with creating a user: ['Invalid email address.']"
