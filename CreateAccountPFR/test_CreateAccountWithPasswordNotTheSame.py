...
class CreateAccountWithPasswordNotTheSame(unittest.TestCase):
    def setUp(self):
    ...
    def test_create_account_with_password_not_the_same(self):
        driver = self.driver
        ...
        driver.find_element(By.ID,"email_address").send_keys("flod@gmail.com")
        ...
        driver.find_element(By.ID,"password2").send_keys("fli")
        driver.find_element(By.ID,"submit").click()

        # SCREENSHOT 
        driver.save_screenshot('.\TEST_ProjetFilRouge\CreateAccountPFR\Screenshots\ErrorPassNotSame.png')
